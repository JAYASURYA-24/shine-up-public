...
class _NotificationsScreenState extends State<NotificationsScreen> {
  ...
  IconData _getNotificationIcon(String title) {
    if (title.contains('Assigned')) return Icons.person_pin;
    if (title.contains('Confirmed')) return Icons.check_circle;
    if (title.contains('Started')) return Icons.build;
    if (title.contains('Completed')) return Icons.star;
    if (title.contains('Cancelled')) return Icons.cancel;
    if (title.contains('Rescheduled')) return Icons.schedule;
    return Icons.notifications;
  }

  Color _getNotificationColor(String title) {
    if (title.contains('Assigned')) return Colors.blue;
    if (title.contains('Confirmed')) return Colors.green;
    if (title.contains('Started')) return Colors.orange;
    if (title.contains('Completed')) return Colors.teal;
    if (title.contains('Cancelled')) return Colors.red;
    if (title.contains('Rescheduled')) return Colors.purple;
    return Colors.grey;
  }
