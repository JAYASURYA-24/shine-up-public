...
import 'package:app_partner/core/websocket/ws_client.dart';
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Text('Customer', style: TextStyle(fontSize: 12, color: Colors.grey[400])),
              ],
            ),
          ],
        ),
                ...
                : _messages.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isMe = msg['sender_role'] == 'PARTNER';
